...
reusableFunctions.calculateExpiry = (currentDate, validityInMonths) => {
    const expiryDate = new Date(currentDate.getFullYear(), currentDate.getMonth() + validityInMonths, currentDate.getDate());
